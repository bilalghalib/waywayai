!(function () {
    ...
    function t() {
        ...
        (r.className = "as-console-row"), r.setAttribute("data-date", e(new Date()));
        var a = r.appendChild(document.createElement("code"));
        return (
            (a.className = "as-console-row-code"),
            "string" == typeof t[0] && t.length > 1 && /((^|[^%])%[sdifoO])/.test(t[0]) ? (a.textContent = n.apply(null, t)) : (a.textContent = [].map.call(t, v.getString).join(" ")),
            h.appendChild(r),
            o(),
    ...
    var a = console.assert,
        ...
        b = 50;
    (m.className = "as-console-wrapper"),
        (h.className = "as-console"),
        document.addEventListener("DOMContentLoaded", function () {
            document.body.appendChild(m).appendChild(h);
        }),
        (y.type = "text/css"),
        (y.textContent = [
    ...
    var v = (function () {
        ...
        function o(n) {
            var o = n.tagName.toLowerCase(),
                t = "<" + o;
            return (
                n.attributes.length > 0 && (t += " "),
                (t += Array.prototype.map
                    .call(n.attributes, function (n) {
                        return "" === n.value ? n.name : n.name + "=" + e(n.value);
                    })
                    .join(" ")),
                (t += ">"),
                (t += n.children.length || n.textContent.length > 79 ? "â€¦" : n.textContent),
                (t += "</" + o + ">")
            );
        }
        function t(r, c) {
            var f,
                ...
                h = a;
            try {
                if (((g = c[r]), g && "object" == typeof g && "function" == typeof g.toJSON && (g = g.toJSON(r)), g instanceof HTMLElement)) return o(g);
                ...
                switch (typeof g) {
                    ...
                    case "object":
                        ...
                        if ((s.push(g), (y = s.length), (m = "/**id:" + y.toString(16) + "**/"), "function" == typeof g)) return m + " " + String(g);
                ...
                return i.call(console, b), "/**error accessing property**/";
            }
        }
        function r(e) {
            if ("string" == typeof e) return e;
            (a = ""), (l = "  "), (s = []);
            for (var n = t("", { "": e }), o = s.length; o; ) new RegExp("/\\*\\*ref:" + o.toString(16) + "\\*\\*/").test(n) || (n = n.replace(new RegExp("[\r\n\t ]*/\\*\\*id:" + o.toString(16) + "\\*\\*/", "g"), "")), o--;
            return (s = null), n;
        }
        var a,
            l,
    ...
    (console.log = function () {
        var e = arguments;
        s && s.apply(console, e), e.length && (t.apply(null, e), r(1));
    }),
        (console.warn = function () {
            var e = arguments;
            e[0].indexOf("You are using the in-browser Babel transformer") === -1 && (f && f.apply(console, e), e.length && (t.apply(null, e).children[0].classList.add("as-console-warning"), r(1)));
        }),
        (console.info = function () {
            var e = arguments;
            c && c.apply(console, e), e.length && (t.apply(null, e).children[0].classList.add("as-console-info"), r(1));
        }),
        (console.error = function () {
            var e = arguments;
            if ((i && i.apply(console, e), e.length)) {
                var n,
                    o = e[0];
                (n = o instanceof Error ? t({ message: o.message, filename: o.filename, lineno: o.lineno, colno: o.colno }) : t.apply(null, e)), n.children[0].classList.add("as-console-error"), r(1);
            }
        }),
        (console.assert = function () {
            var e = arguments;
            if ((a && a.apply(console, e), !e[0])) {
                var n = t.apply(null, Array.prototype.slice.call(e, 1));
                n.children[0].classList.add("as-console-assert"), r(1);
            }
        }),
        (console.dir = function () {
            var e = arguments;
            l && l.apply(console, e), e.length && (t(e[0]), r(1));
        }),
        (console.clear = function () {
            for (; h.lastChild; ) h.removeChild(h.lastChild);
            u && u.apply(console, arguments), r(0);
        }),
        (console.time = function (e) {
            var n = performance.now();
            d && d.apply(console, arguments), arguments.length || (e = "default"), (g[e] = n);
        }),
        (console.timeEnd = function (e) {
            var n = performance.now();
            if ((p && p.apply(console, arguments), arguments.length || (e = "default"), e in g)) {
                var o = n - g[e];
                delete g[e], t("%s: %sms", e, o.toFixed(3)), r(1);
            }
        }),
        (console.config = function (e) {
            "object" == typeof e && e.maxEntries > 0 && ((b = e.maxEntries), o()), console.log({ maxEntries: b });
        }),
        window.addEventListener("error", function (e) {
            t({ message: e.message, filename: e.filename, lineno: e.lineno, colno: e.colno }).children[0].classList.add("as-console-error"), r(1);
        });
})();
