...
function saveDynamicDataToFile() {
    ...
    var linesURLImage = "https://draw.wayway.ai/davstyle/uploads/" + linesName + "lin.png"
    var linesURLText = "https://draw.wayway.ai/davstyle/uploads/" + linesName + "lin.txt"
    ...
    $.ajax({
        ...
        success: function(response) {
            $("#upload-status-text").html("Successfully saved on wayway.io!");
